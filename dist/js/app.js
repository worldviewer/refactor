...
var DesktopInfographic = function () {
	...
	_createClass(DesktopInfographic, [{
		...
		value: function init() {
			...
			_utils2.default.loadScript("dist/js/impress.js", myPrettyCode);
		}
	}]);
...
},{"./desktop-infographic.js":7,"./infographic.js":8,"./mobile-infographic.js":10}],10:[function(require,module,exports){
'use strict';
...
var MobileInfographic = function () {
	...
	_createClass(MobileInfographic, [{
		...
		value: function init() {
			...
			var newSlides = function newSlides() {
